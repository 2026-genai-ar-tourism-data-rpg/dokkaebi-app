...
// ------------------------------------------------------------
// [v3] ActionAtom.correctCoupon 제거 — 쿠폰 보상을 없앴다(AI도 correct.coupon을 더 보내지 않는다).
//      coupon 상태 어휘(StateKind.coupon)는 예전 코스 저장값을 읽으려고 남긴다.
...
const strategyLabels = <String, String>{
  ...
  'S2': '사냥→수집',
  'S3': '퀴즈→개봉',
  'S4': '불꽃→추적→파편',   // [fire-capture] 촬영 미션 → 도깨비불 길들이기
  'S5': '불꽃 모으기',
  'S6': '수집 누적',
  'S7': '주문 인증',
};
