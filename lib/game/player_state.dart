...
// ------------------------------------------------------------
// [v2] 굿 엔딩 친밀도 기준 — goodEndingAffinityFor(사연을 물을 수 있는 장소 수의 절반, 올림).
// 구현일: 2026-09-19 | 작성: ljs (coupon-affinity/ljs/v1)
// ============================================================
import '../models/scenario.dart';

/// 굿 엔딩이 열리는 친밀도 — 사연을 물을 수 있는 장소(피날레 제외) [places]곳의 절반(올림).
/// 장소 대화에서 사연을 물으면(A) 친밀도 +1, 장소마다 한 번이다. 장소가 없으면 0(늘 열림).
int goodEndingAffinityFor(int places) => places <= 0 ? 0 : (places + 1) ~/ 2;
